...
type SentryQuery struct {
	...
	ReleasesQuery         string   `json:"releasesQuery,omitempty"`
	ReleasesLimit         int64    `json:"releasesLimit,omitempty"`
	DeploysReleaseVersion string   `json:"deploysReleaseVersion,omitempty"`
	DeploysLimit          int64    `json:"deploysLimit,omitempty"`
