...
| Query        | (optional) Enter your sentry query to get the relevant results. If you wish to filter by fields on issues you should use the format `FIELD_NAME:FIELD_VALUE`|
